...
const DeletedMedia = async (conn, mek, jid, deleteInfo, messageType) => {
    ...
    // Then send the original media with its original caption (if any)
    if (messageType === 'imageMessage' || messageType === 'videoMessage' || messageType === 'documentMessage') {
        ...
        // For images and videos, we keep the original caption if it exists
        if (messageType === 'imageMessage' && mediaMessage.imageMessage?.caption) {
            // Keep original caption for image
            ...
            // Keep original caption for video
            ...
            // Keep original caption for document
        ...
        // For stickers, audio, voice messages - just forward as is
