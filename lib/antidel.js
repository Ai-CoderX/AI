            ...
            if (store && store.message) {
                ...
                if (isGroup) {
                    try {
                        ...
                        jid = ANTI_DELETE_PATH === "inbox" ? conn.user.id.split(':')[0] + "@s.whatsapp.net" : store.jid;
                    } catch (e) {
                    ...
                    deleteInfo = `*╭────⬡ KHAN-MD ⬡────*\n*├▢ SENDER :* @${senderNumber}\n*├▢ ACTION :* Deleted a Message`;
                    // FIXED: Proper JID formatting for inbox
                    jid = ANTI_DELETE_PATH === "inbox" ? conn.user.id.split(':')[0] + "@s.whatsapp.net" : update.key.remoteJid || store.jid;
                }
