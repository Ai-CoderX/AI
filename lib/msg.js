...
const sms = (conn, m, store) => {
    ...
    if (m.message) {
        ...
        // Check if m.msg exists before accessing its properties
    ...
    m.text = m.msg && (m.msg.text || m.msg.caption) || m.message && m.message.conversation || m.msg && (m.msg.contentText || m.msg.selectedDisplayText || m.msg.title) || ''
